...
def main():
    test = htf.Test(
        check_button,
        # procedure_id="FVT13", # No need to specify the ID
        procedure_name="PCBA Testing OpenHTF",  # Create procedure name
        procedure_version="1.2.18",  # Create procedure version
        part_number="00220",
        revision="B",
    )
