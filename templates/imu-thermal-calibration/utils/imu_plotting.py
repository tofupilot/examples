...
def plot_sensor_data(temp, actual, fitted, residuals, axis_label, y_label, sensor_type, save_path):
    ...
    fig_file = os.path.join(save_path, f'{sensor_type}_{axis_label_sanitized}_calibration.png')
