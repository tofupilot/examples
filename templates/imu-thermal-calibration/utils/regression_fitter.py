...
class IMUThermalCalibration(BasePlug):
    ...
    def __init__(self):
        ...
        self.polynomial_order = getattr(CONF, 'polynomial_order', 3)
        self.max_bias_threshold = getattr(CONF, 'max_bias_threshold', 0.5)
        self.data_save_path = getattr(CONF, 'data_save_path', 'imu_calibration_results')
