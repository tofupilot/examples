...
@measures(
    htf.Measurement("acc_max_bias").in_range(0.0, ACC_MAX_BIAS_LIMIT).with_units(units.METRE_PER_SECOND_SQUARED),
    htf.Measurement("acc_residuals"),
    htf.Measurement("acc_r2"),
    htf.Measurement("acc_noise_density").in_range(0.0, ACC_NOISE_DENSITY_LIMIT).with_units(units.METRE_PER_SECOND_SQUARED),
