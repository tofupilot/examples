...
@htf.measures(
    ...
    htf.Measurement("sensor_adc_accuracy").in_range(0.95, 1.05).with_units(units.PERCENT),
    htf.Measurement("sensor_temperature_reading").in_range(-10, 85).with_units(units.CELSIUS),
)
